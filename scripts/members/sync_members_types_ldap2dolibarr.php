 ...
 * \ingroup ldap member
 * \brief 	Script to update members types into ZionOne from LDAP
 */
...
if (!getDolGlobalString('LDAP_MEMBER_TYPE_DN')) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members types not defined inside ZionOne");
	exit(1);
}
