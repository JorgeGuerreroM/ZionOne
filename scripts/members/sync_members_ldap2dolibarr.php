 ...
 * \ingroup ldap member
 * \brief Script de mise a jour des adherents dans ZionOne depuis LDAP
 */
...
if (!getDolGlobalString('LDAP_MEMBER_DN')) {
	print $langs->trans("Error").': '.$langs->trans("LDAP setup for members not defined inside ZionOne")."\n";
	exit(1);
}
if ($typeid <= 0) {
