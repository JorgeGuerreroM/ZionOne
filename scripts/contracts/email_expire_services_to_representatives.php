 ...
 * \ingroup contracts
 * \brief Script to send a mail to ZionOne users linked to companies with services to expire
 */
...
if ($resql) {
	...
	if ($num) {
		...
		print "No services to expire (for companies linked to a particular commercial ZionOne user) found\n";
	}
