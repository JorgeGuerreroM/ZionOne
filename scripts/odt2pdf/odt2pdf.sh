...
# ZionOne variable MAIN_ODT_AS_PDF must be defined ...
...
# ZionOne variable MAIN_DOL_SCRIPTS_ROOT must be defined to path of script directories (otherwise ZionOne will try to guess).
#
