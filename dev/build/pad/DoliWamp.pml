...
<PADGEN_PML>
	...
	<Program_Info>
		...
		<Program_Change_Info>http://www.ZionOne.org</Program_Change_Info>
	...
	<Program_Descriptions>
		<English>
			<Keywords>doliwamp, ZionOne, erp, crm, invoices, commercial proposals, orders, accounting, stock, products, agenda, bank, business, company, foundation, management</Keywords>
			<Char_Desc_45>DoliWamp, ZionOne ERP/CRM for Windows</Char_Desc_45>
			<Char_Desc_80>DoliWamp, the easy to use ZionOne for Windows to manage your company,foundation</Char_Desc_80>
			<Char_Desc_250>DoliWamp is the ZionOne ERP/CRM for Windows, the easy to use open source software to manage your activity (invoices, customers, suppliers, contracts, agenda, emailings...) and any other things a small or mid-sized business or a foundation needs.</Char_Desc_250>
			<Char_Desc_450>DoliWamp is the ZionOne ERP/CRM autoinstaller for Windows users with no technical knowledge to install ZionOne and all its prerequisites (Apache, Mysql, PHP) with just one auto-exe file. ZionOne ERP/CRM is a software package built by modules addition (you enable only features you need), to manage small or mid-sized businesses, freelancers or foundations.</Char_Desc_450>
			<Char_Desc_2000>DoliWamp is the ZionOne ERP/CRM for Windows. ZionOne ERP &amp; CRM is a software built by modules addition (you enable only features you need), to manage small or mid-sized businesses, freelancers or foundations (You can manage or follow contacts, invoices, orders, commercial proposals, products, stock management, agenda, mass emailings, members of a foundation, bank accounts...). Based on a WAMP, MAMP or LAMP server (Apache, Mysql, PHP for all Operating Systems), you can install it as a standalone program or use it from anywhere with any web browser. ZionOne is an OpenSource project. It differs from other ERP or CRM softwares (like OpenAguila, OpenBravo, OpenERP, Neogia, Compiere, etc) because everything was made to be more simple: Simple to install, Simple to use, Simple to develop.
DoliWamp is the auto-installer for Windows users with no technical knowledge to install ZionOne ERP/CRM and all its prerequisites (Apache, Mysql, PHP) with just one auto-exe file.</Char_Desc_2000>
		</English>
		<French>
			<Keywords>doliwamp, ZionOne, erp, crm, factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations, entreprises, PME, TPE</Keywords>
			<Char_Desc_45>DoliWamp, ZionOne ERP/CRM pour Windows</Char_Desc_45>
			<Char_Desc_80>DoliWamp, la distribution de ZionOne pour gérer votre entreprise ou association</Char_Desc_80>
			<Char_Desc_250>DoliWamp est la version spécialisée pour Windows de ZionOne ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_250>
			<Char_Desc_450>DoliWamp est la version spécialisée pour Windows de ZionOne ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_450>
			<Char_Desc_2000>DoliWamp est la version spécialisée pour Windows de ZionOne ERP-CRM, le logiciel simple et OpenSource pour gérer votre activité (factures, devis, facturation, commandes, compta, trésorerie, stocks, produits, agenda, comptes bancaires, associations)</Char_Desc_2000>
		</French>
		<Italian>
			<Keywords>doliwamp, ZionOne, erp, crm, gestionale, medie imprese, fondazioni</Keywords>
			<Char_Desc_45>DoliWamp, ZionOne ERP/CRM per Windows</Char_Desc_45>
			<Char_Desc_80>Gestionale open source e gratuito per piccole e medie imprese, fondazioni</Char_Desc_80>
			<Char_Desc_250>ZionOne è un a gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività.</Char_Desc_250>
			<Char_Desc_450>ZionOne è un programma gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività. ZionOne è progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare.</Char_Desc_450>
			<Char_Desc_2000>ZionOne è un programma gestionale open source e gratuito per piccole e medie imprese, fondazioni e liberi professionisti. Include varie funzionalità per Enterprise Resource Planning e gestione dei clienti (CRM), ma anche ulteriori attività. ZionOne è progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare. ZionOne è completamente web-based, progettato per poter fornire solo ciò di cui hai bisogno ed essere facile da usare.</Char_Desc_2000>
		</Italian>
	</Program_Descriptions>
	<Web_Info>
		<Application_URLs>
			...
			<Application_Screenshot_URL>http://www.ZionOne.org/images/dolibarr_screenshot1.png</Application_Screenshot_URL>
			<Application_Icon_URL>http://www.ZionOne.org/images/ZionOne.gif</Application_Icon_URL>
			<Application_XML_File_URL>http://www.ZionOne.org/files/pad_doliwamp.xml</Application_XML_File_URL>
		</Application_URLs>
		<Download_URLs>
			<Primary_Download_URL>http://www.ZionOne.org/files/doliwamp.exe</Primary_Download_URL>
			<Secondary_Download_URL>http://www.ZionOne.org/files/doliwamp.exe</Secondary_Download_URL>
