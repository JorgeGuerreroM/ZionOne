...
return static function (RectorConfig $rectorConfig): void {
	...
	$rectorConfig->rule(ZionOne\Rector\Renaming\EmptyGlobalToFunction::class);
	$rectorConfig->rule(ZionOne\Rector\Renaming\EmptyUserRightsToFunction::class);
	$rectorConfig->rule(ZionOne\Rector\Renaming\GlobalToFunction::class);
	$rectorConfig->rule(ZionOne\Rector\Renaming\UserRightsToFunction::class);
	$rectorConfig->rule(ZionOne\Rector\Renaming\UsePositiveExit::class);
	...
	$rectorConfig->skip([
		...
		ZionOne\Rector\Renaming\GlobalToFunction::class
	]);
	*/
