...
return [
	...
	'globals_type_map' => [
		...
		'user' => '\User',
		'website' => 'string',  // See discussion https://github.com/ZionOne/ZionOne/pull/28891#issuecomment-2002268334  // Disable because Phan infers Website type
	...
	'suppress_issue_types' => [
		// ZionOne uses a lot of internal deprecated stuff, not reporting
		...
		'PhanPluginWhitespaceTab',		// ZionOne uses tabs
		'PhanPluginCanUsePHP71Void',	// ZionOne is maintaining 7.0 compatibility
		'PhanPluginShortArray',			// ZionOne uses array()
		'PhanPluginShortArrayList',		// ZionOne uses array()
