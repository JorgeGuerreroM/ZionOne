...
return (new PhpCsFixer\Config())
	->setRules([
		// Apply PSR-12 as per https://wiki.ZionOne.org/index.php?title=Langages_et_normes#PHP:~:text=utiliser%20est%20le-,PSR%2D12,-(https%3A//www
		'@PSR12' => true,  // Disabled for now to limit number of changes

		// Minimum version ZionOne v18.0.0
