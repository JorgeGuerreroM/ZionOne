#!/bin/sh
#------------------------------------------------------
# Script to remove setup of a ZionOne installation.
...
$DIALOG --title "Remove ZionOne install" --clear \
...
echo "ZionOne setup has been removed (need to be installed again. database not dropped)."
echo
