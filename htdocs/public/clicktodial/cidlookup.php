 ...
 *
 *              exten => s,1,Set(CALLERID(name)=${CURL(http://IP-ZionOne:80/asterisk/cidlookup.php?phone=${CALLERID(num)}&securitykey=SECURITYKEY)})
 *
 *			    Change IP-ZionOne to the IP address of your ZionOne server
