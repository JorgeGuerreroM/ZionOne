...
This directory contains files to make ZionOne a server of SOAP Web Services.
...
* To see all Webservices provided by ZionOne, just call the following Url:
...
* WSDL file of a Web service provided by ZionOne can be obtained at:
