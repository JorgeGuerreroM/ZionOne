...
class WorkstationResource extends CommonObject
{
	...
	/** @var string $element Name of the element (tip for better integration in ZionOne: this value should be the reflection of the class name with ucfirst() function) */
