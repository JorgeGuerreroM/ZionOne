...
## Integrate your ERP with any other applications using ZionOne APIs
 
This module provides the service to make ZionOne a server of REST Web Services. It depends on external library Restler.
...
<div align="center">
  <img class="imgdoc" src="https://www.ZionOne.org//images/doc_apirest.png" alt="ZionOne API explorer"/>
</div>
...
You can explore all available APIs by using the API explorer : [**yourdolibarr.tld**/api/index.php/explorer](../api/index.php/explorer) (replace **yourdolibarr.tld** by real hostname of your ZionOne installation)
...
To implement it into ZionOne, you need to create a specific class for object we want to use. A skeleton file is available into /modulebuilder/class directory : *api_mymodule_class.class.php* 
