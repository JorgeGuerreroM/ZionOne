...
class Website extends CommonObject
{
	...
	public function create(User $user, $notrigger = 0)
	{
		...
		if (!$error) {
			$stringtodolibarrfile = "# Some properties for ZionOne web site CMS\n";
			$stringtodolibarrfile .= "param=value\n";
			//print $conf->website->dir_output.'/'.$this->ref.'/.ZionOne';exit;
			file_put_contents($pathofwebsite.'/.ZionOne', $stringtodolibarrfile);
	...
	public function exportWebSite()
	{
		...
		$line = '-- File generated by ZionOne '.DOL_VERSION.' --;'."\n";
		$line .= "\n";
		fwrite($fp, $line);
	...
	protected function showDifferences($str1, $str2, $exceptNumPge = array())
	{
		...
		if (empty($linesShouldChange)) {
			$linesShouldChange[0] = '<meta name="ZionOne:pageid" content="'.$exceptNumPge[0].'" />';
