 ...
 *	\brief      Class file to manage ZionOne database access for a MySQL database
 */

require_once DOL_DOCUMENT_ROOT.'/core/db/DoliDB.class.php';

/**
 *	Class to manage ZionOne database access for a MySQL database using the MySQLi extension
 */
class DoliDBMysqli extends DoliDB
{
	...
	public function errno()
	{
		if (!$this->connected) {
			...
			// Constants to convert a MySql error code to a generic ZionOne error code
			$errorcode_map = array(
