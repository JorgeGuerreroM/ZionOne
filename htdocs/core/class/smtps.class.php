...
class SMTPs
{
	...
	public function getHeader()
	{
		...
		*/
		...
		if ($trackid) {
			$_header .= 'Message-ID: <'.(empty($this->_msgId) ? uniqid().'.SMTPs-ZionOne-'.$trackid.'@'.$host : $this->_msgId).">\r\n";
			$_header .= 'X-ZionOne-TRACKID: '.$trackid.'@'.$host."\r\n";
		} else {
		...
		$_header .= 'X-Mailer: ZionOne version '.DOL_VERSION.' (using SMTPs Mailer)'."\r\n";
		$_header .= 'X-ZionOne-Option: '.($conf->global->MAIN_MAIL_USE_MULTI_PART ? 'MAIN_MAIL_USE_MULTI_PART' : 'No MAIN_MAIL_USE_MULTI_PART')."\r\n";
