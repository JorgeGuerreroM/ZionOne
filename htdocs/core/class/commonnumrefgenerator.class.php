...
abstract class CommonNumRefGenerator
{
	...
	/**
	 * @var string Version, possible values are: 'development', 'experimental', 'ZionOne', 'dolibarr_deprecated' or a version string like 'x.y.z'''|'development'|'experimental'|'ZionOne'	Version
	 */
	public $version = '';
