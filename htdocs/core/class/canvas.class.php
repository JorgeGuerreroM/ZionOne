...
class Canvas
{
	...
	public function getCanvas($module, $card, $canvas)
	{
		...
		// Set properties with value specific to ZionOne core: this->targetmodule, this->card, this->canvas
	...
	// https://wiki.ZionOne.org/index.php/Canvas_development
	 ...
	 * 	@see		https://wiki.ZionOne.org/index.php/Canvas_development
	 */
