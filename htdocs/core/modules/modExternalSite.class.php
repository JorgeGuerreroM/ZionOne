 ...
 * \brief      Module to include an external web site/tools into ZionOne menu and into a frame page.
...
class modExternalSite extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "This module include an external web site or page into ZionOne menus and view it into a ZionOne frame.";
