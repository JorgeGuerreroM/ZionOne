...
class modAsset extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->numero = 51000; // TODO Go on page https://wiki.ZionOne.org/index.php/List_of_modules_id to reserve id number for your module
		...
		$this->need_dolibarr_version = array(7, 0); // Minimum version of ZionOne required by module
	 ...
	 *  The init function adds constants, boxes, permissions and menus (defined in constructor) into ZionOne database.
