...
class modOpenSurvey extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// Use here a free id (See in Home -> System information -> ZionOne for list of used module id).
		$this->numero = 55000;
		...
		$this->need_dolibarr_version = array(3, 4, 0); // Minimum version of ZionOne required by module
