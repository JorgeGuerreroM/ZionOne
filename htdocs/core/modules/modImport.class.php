 ...
 *  \brief      Module to make generic import of data into ZionOne database
...
class modImport extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "Outils d'imports de donnees ZionOne (via un assistant)";
		...
		$this->phpmax = array();
		$this->need_dolibarr_version = array(2, 7, -1); // Minimum version of ZionOne required by module
