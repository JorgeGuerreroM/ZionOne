 ...
 *
 * Warning: for the box to be detected correctly by ZionOne,
...
class mymodulewidget1 extends ModeleBoxes
{
	...
	/**
	 * Load data into info_box_contents array to show array later. Called by ZionOne before displaying the box.
	 *
