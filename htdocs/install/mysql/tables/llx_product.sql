...
(
  ...
  ref_ext                       varchar(128),                       -- reference into an external system (not used by ZionOne)
  ...
  note                          mediumtext,
  customcode                    varchar(32),                        -- Customs|Commodity|HS|TARIC code see https://github.com/ZionOne/ZionOne/issues/31679
